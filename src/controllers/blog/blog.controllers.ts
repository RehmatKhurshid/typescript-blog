...
import { createblog, deleteBlog, getOneBlog, getblog, updateblog } from "../../services/blog/blog.services";
...
export const createBlog = async (req: Request, res: Response) => {
    try {
        ...
        logger.error('error in create blog', JSON.stringify(error));
...
export const getBlog = async (req: Request, res: Response) => {
    try {
        ...
        logger.error('error in get blog', JSON.stringify(error));
...
export const removeBlog = async (req: Request, res: Response) => {
    try {
      ...
      logger.error('error in delete user', JSON.stringify(error));
...
export const getBlogById = async (req: Request, res: Response) => {
    try {
        ...
        logger.error('error in get blog by id', JSON.stringify(error));
